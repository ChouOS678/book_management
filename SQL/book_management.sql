...
CREATE TABLE `books` (
  ...
  `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '书籍标题',
  `author` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '作者',
  `可借阅书籍` int NOT NULL DEFAULT '0' COMMENT '可借阅数量',
...
CREATE TABLE `users` (
  ...
  `role` enum('普通用户','管理员') NOT NULL COMMENT '0表示普通用户，1表示管理员',
...
-- Dump completed on 2025-05-29  0:08:19
